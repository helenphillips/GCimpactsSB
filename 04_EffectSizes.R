...
nrow(abundance[which(abundance$Control_mean == 0),]) # 129
nrow(abundance[which(abundance$Control_SD   == 0),]) # 150

table(abundance$driver[which(abundance$Control_SD   == 0)]) # Mainly lui, nutrient enrichment and pollution


nrow(abundance[which(abundance$Treatment_mean  == 0),]) # 159
...
EffectSizes$VarLRR[which(EffectSizes$driver == "Pollution" & EffectSizes$VarLRR == 0)] <- median(EffectSizes$vi[EffectSizes$driver == "Pollution"], na.rm = TRUE)
EffectSizes$VarLRR[which(EffectSizes$driver == "Climate" & EffectSizes$VarLRR == 0)] <- median(EffectSizes$vi[EffectSizes$driver == "Climate"], na.rm = TRUE)
EffectSizes$VarLRR[which(EffectSizes$driver == "Invasives" & EffectSizes$VarLRR == 0)] <- median(EffectSizes$vi[EffectSizes$driver == "Invasives"], na.rm = TRUE)
EffectSizes$VarLRR[which(EffectSizes$driver == "LUI" & EffectSizes$VarLRR == 0)] <- median(EffectSizes$vi[EffectSizes$driver == "LUI"], na.rm = TRUE)
EffectSizes$VarLRR[which(EffectSizes$driver == "NutrientEnrichment" & EffectSizes$VarLRR == 0)] <-median(EffectSizes$vi[EffectSizes$driver == "NutrientEnrichment"], na.rm = TRUE)
